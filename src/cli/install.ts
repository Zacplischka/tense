 ...
 */
export function serverEnv(opts: InstallOptions = {}): Record<string, string> {
...
export function mcpServerEntry(opts: InstallOptions = {}): {
  command: string;
  args: string[];
...
export function renderMcpJson(opts: InstallOptions = {}): string {
...
export function renderClaudeAddCommand(opts: InstallOptions = {}): string {
...
export function renderInstall(opts: InstallOptions = {}): string {
  const lines = [
